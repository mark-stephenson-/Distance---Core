        ...
        <tr>
            ...
            <td>
                <div class="progress">
                    ...
                    ?>
                    @if($total > 0)
                        <div class="bar bar-danger" style="width: {{ (@$question->answers->{"1"}/$total) * 100 }}%;" data-toggle="tooltip" data-placement="top" title="Negative-: {{ @$question->answers->{"1"} }}"> </div>
                        <div class="bar bar-warning" style="width: {{ (@$question->answers->{"2"}/$total * 100) }}%;" data-toggle="tooltip" data-placement="top" title="Negative: {{ @$question->answers->{"2"} }}"> </div>
                        <div class="bar bar-neutral" style="width: {{ (@$question->answers->{"3"}/$total * 100) }}%;" data-toggle="tooltip" data-placement="top" title="Neutral: {{ @$question->answers->{"3"} }}"> </div>
                        <div class="bar bar-positive" style="width: {{ (@$question->answers->{"4"}/$total * 100) }}%;" data-toggle="tooltip" data-placement="top" title="Positive: {{ @$question->answers->{"4"} }}"> </div>
                        <div class="bar bar-success" style="width: {{ (@$question->answers->{"5"}/$total * 100) }}%;" data-toggle="tooltip" data-placement="top" title="Positive+: {{ @$question->answers->{"5"} }}"> </div>
                    @else
